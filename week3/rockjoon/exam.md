...
![](images/3.png)
* 앱 사용자는 사용자 풀을 통해 로그인하여 인증 성공 이후 사용자 풀 토큰을 받음
* 앱은 자격 증명 풀을 통해 사용자 풀 토큰을 AWS 자격 증명으로 교환
* 앱 사용자는 AWS 자격 증명을 사용하여 AWS 리소스에 접근

## 문제 풀이


A. IAM 역할
> IAM은 AWS 리소스에 대한 액세스를 제어함. 어플리케이션에 대한 권한부여/인증과는 관련 없다.
